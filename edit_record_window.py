...
def edit_record(clicked_data):
    ...
    def push_data():
        ...
        # INSERT UPDATED DATA
        backend.update_record(id, title_en, username_en, password_en,notes_en,  last_modified_en)
        root.destroy()
    ...
    def display_data():
        ...
        input_field_title.insert(0, clicked_data[1])
        input_field_uname.insert(0,  clicked_data[2])
        input_field_password.insert(0,  clicked_data[3])
        input_field_notes.insert(tk.END,  clicked_data[4])
